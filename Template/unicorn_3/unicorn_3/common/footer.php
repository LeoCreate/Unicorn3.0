...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp cl">
		<div id="flk" class="y">
			<p>
				...
				<!--{loop $_G['setting']['footernavs'] $nav}--><!--{if $nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
						!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))}-->$nav[code]<span class="pipe">|</span><!--{/if}--><!--{/loop}--><!--{hook/global_footerlink}-->
		...
		<div id="frt">
			<p>核心程序：<a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--><em> & <a href="http://www.hp-forum.com/thread-1136-1-1.html" target="_blank">Unicorn</a> 3.1</em></p>
			<p class="xs0">&copy; 2015-2020 <a href="http://www.hp-forum.com/" target="_blank">魔法世界演绎论坛<!--{if $_G['setting']['icp']}-->( <a href="http://www.miitbeian.gov.cn/" target="_blank">$_G['setting']['icp']</a> )<!--{/if}--></a> 版权所有</p>
		</div>
		<!--{eval updatesession();}-->
